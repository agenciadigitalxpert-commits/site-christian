...
LANDING_PAGES = [
    {
        ...
        "description": "Implantes, harmonização, ortodontia e odontologia geral em 5 unidades em Curitiba. Agende sua avaliação pelo WhatsApp.",
        "eyebrow": "Instituto Christian Andrade · desde 2005",
        "h1": "O sorriso que você adia há anos pode começar hoje",
        "sub": "Implantes, harmonização orofacial, ortodontia e odontologia geral — uma equipe multidisciplinar avalia seu caso e monta o plano certo pra você, em 5 unidades na região de Curitiba.",
        "cta": "Agendar minha avaliação",
        "img": "consulta",
        "trust": ["20+ anos de atuação", "5 unidades em Curitiba e região", "Equipe multidisciplinar especializada"],
        "wa_msg": "Olá, vim pelo site e quero agendar uma avaliação!",
